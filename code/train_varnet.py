...
def build_args():
    ...
    parser.add_argument(
        ...
        default=0,
        type=int,
        help="train with exp loss or not",
    )
    parser.add_argument(
        "--center_fractions",
        nargs="+",
    ...
    parser.set_defaults(
        num_cascades= 12, #12, #6,  # number of unrolled iterations
        pools=4,  # number of pooling layers for U-Net
        chans=16,  # number of top-level channels for U-Net
