...
class CombinedSliceDataset(torch.utils.data.Dataset):
    ...
    def __init__(
        ...
        dataset_cache_file: Union[str, Path, os.PathLike] = "dataset_cache_ext_train.pkl",
...
class SliceDataset(torch.utils.data.Dataset):
    ...
    def __init__(
        ...
        self.dataset_cache_file = Path('/cluster/scratch/jonatank') / Path(dataset_cache_file)
        ...
        #print(dataset_cache.keys())
        #print(root)
        if not use_dataset_cache or dataset_cache.get(root) is None:# or 
