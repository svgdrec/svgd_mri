...
class FastMriDataModule(pl.LightningDataModule):
    ...
    def _create_data_loader(
        ...
        if is_train and self.combine_train_val:
            data_paths = [
                self.data_path / f"train_ext", #f"{self.challenge}_train",
                self.data_path / f"validation_ext", #f"{self.challenge}_val",
            ]
            ...
            if data_partition in ("test", "challenge") and self.test_path is not None:
                ...
                data_path = self.data_path / f"test_ext" #f"{self.challenge}_{data_partition}"
    ...
    def prepare_data(self):
        ...
        if self.use_dataset_cache_file:
            if self.test_path is not None:
                ...
                test_path = self.data_path / f"test_ext"
            data_paths = [
                self.data_path / f"train_ext", #f"{self.challenge}_train",
                self.data_path / f"validation_ext", #f"{self.challenge}_val",
                test_path,
